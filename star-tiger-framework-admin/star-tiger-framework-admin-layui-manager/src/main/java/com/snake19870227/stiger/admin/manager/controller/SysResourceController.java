...
public class SysResourceController {
    ...
    @ResponseBody
    public RestResp<List<TransferData>> getTransferData(@RequestParam(name = "roleFlow", required = false) String roleFlow) {
    ...
    @PutMapping
    @ResponseBody
    public RestResp<SysResource> update(@RequestBody SysResource resource) {
    ...
    @PutMapping(path = "/enableStatus/{resFlow}/{flag}")
    @ResponseBody
